...
\textbf{CMSs}: Wordpress, Jommla, Umbraco, Sitecore, WHMCS, DataLife Engine, Drupal, Magento\\
...
Automation, HTML, CSS, Python, PHP, C, C\#, Windows Forms, WPF, JavaScript, XML, Android (Java, and Kotlin), FreeBSD, GNU/Linux, SQL/NoSQL Databases, Discord and Telegram Bots, etc.
\resumeItemListEnd

\resumeSubHeadingListEnd

\vspace{-6.5mm}	
\section{\textbf{Public Projects}}
...
I have up to 2,000 public projects and repositories on my GitHub profile. Feel free to explore and find any projects you have in mind. Most of them are public and available for you to check and review at \href{https://github.com/BaseMax}{https://github.com/BaseMax}.
