...
%-------------------------------------------
\newcommand{\name}{Seyyed Ali Mohammadiyeh}
\newcommand{\course}{Senior Software Engineer, and Full-Stack Developer}
\newcommand{\phone}{+32 470 11 51 12}
\newcommand{\emaila}{maxbasecode@gmail.com}
\newcommand{\github}{BaseMax}
\newcommand{\website}{https://mohammadiyeh.com}
...
\begin{tabularx}{\linewidth}{L r}
	...
	{Iranian and Residency in Iran and Estonia (Sep 2023 - Sep 2028)} &  \href{https://github.com/\github}{GitHub} \\
...
\vspace{6pt}
\textbf{Programming Languages}: Bash, C, C\#, C++, CSS 3, D, Go, GAP System, HTML 5, Java, JavaScript, PHP 8.3, Python 3.12, Ruby, SageMath, TypeScript (sorted alphabetically)\\
\textbf{Tools and Frameworks}: Grafana, ArgoCD, CI/CD, Git, GitHub, Gitlab, Bitbucket, GitHub Actions, Jenkins, Pre-Commit, .NET Core, .NET Framework, CakePHP, Codeigniter 3-4, ExpressJS, GORM, XORM, Ginkgo, GoMock, Gin, Echo, Beego, gRPC, Colly, WebSocket, Socket.IO, Auth0, JWT, Protobuf, Laravel 11, Symfony,  CakePHP, NestJS, NextJS, NuxtJS, VueJs, ReactJS, React Native, Tailwind CSS, Xamarin, Vite, WebPack, Laravel Horizon, Serilog, RabbitMQ, Swagger, Postman, Hangfire, Apache JMeter, LoadRunner, BlazeMeter, Selenium, Appium, Puppeteer, TestRail, Spring Boot, Ktor, Shopify, LLVM, FastAPI, Flask, Django, Django REST framework, Ruby on Rails\\
...
\vspace{-1mm}
\resumeSubheading
{BSafe Group}{Part-Time}
{Senior Project Manager}{March 2025 - Present}
\resumeItemListStart
Lead cross-functional teams across construction, technology, and logistics projects, coordinating engineers, consultants, and stakeholders to deliver complex initiatives on schedule and within budget.\\
Drive strategic project planning, execution, and delivery while actively contributing to product and technical decisions for internal IT platforms.\\
Identify market opportunities and support business expansion by launching new technology-driven solutions and improving operational processes.\\
Establish structured project management workflows, performance metrics, and reporting systems to ensure measurable outcomes for enterprise clients.
\resumeItemListEnd

\vspace{-1mm}
\resumeSubheading
{Mobile Communications of Iran (MCI) - Largest Telecom Operator in Iran}{Full-Time}
{Team Lead}{February 2026 - Present (Pause due to War)}
\resumeItemListStart
Lead the engineering team behind one of Iran largest search engine and AI (Artificial Intelligence) platforms, supporting large-scale information retrieval and intelligent services.\\
Architect and operate high-performance backend systems handling more than 50,000 requests per second with strict reliability and latency requirements.\\
Coordinate research, infrastructure, and product teams to develop scalable search, ranking, and AI-driven services.\\
Mentor engineers and guide system design, performance optimization, and distributed infrastructure development.
\resumeItemListEnd

\vspace{-1mm}
\resumeSubheading
{Rial Payment Credit}{Part-Time, Remote}
{Lead Developer}{January 2025 - Present (Remote)}
\resumeItemListStart
...
\vspace{-1mm}
\resumeSubheading
{Iranian Credit Card}{Full-Time, Hybrid}
{Engineering Manager}{February 2024 - February 2025}
\resumeItemListStart
...
\vspace{-1mm}
\resumeSubheading
{GitHub}{Part-Time, Remote}
{Open-Source Maintainer}{February 2018 - Present}
\resumeItemListStart
...
\vspace{-1mm}
\resumeSubheading
{Inisev Ltd.}{Full-Time, Malta - Remote}
{Team Lead - Senior Software Engineer}{February 2023 - February 2025}
\resumeItemListStart
...
{Part-time C\# Back-End Developer}{July 2023 - December 2023}
\resumeItemListStart
...
{Software Engineer}{March 2023 - February 2024}
\resumeItemListStart
...
{.NET Core Developer - Senior Software Engineer}{August 2023 - November 2023}
\resumeItemListStart
...
{.NET - C\# Back-End Developer}{September 2023 - January 2024}
\resumeItemListStart
...
{Senior Software Engineer}{February 2023 - September 2023}
\resumeItemListStart
...
{Tech Architect}{February 2023 - December 2023}
\resumeItemListStart
...
{Senior Front-End Engineer and Back-End Engineer - TypeScript}{January 2022 - December 2023}
\resumeItemListStart
...
{Senior QA Engineer - Test Engineer}{January 2023 - July 2023}
\resumeItemListStart
...
Automatically responded to messages for Domino's Pizza using AI (Artificial Intelligence) assistance.
\resumeItemListEnd

\vspace{-1mm}
\resumeSubheading
{ERP Solutions}{New York - Remote}
{Senior Front-End Developer}{July 2021 - January 2022}
\resumeItemListStart
...
{Senior Software Engineer, and Full-Stack Developer (Front-End and Back-End)}{January 2023 - November 2023}
\resumeItemListStart
...
{Senior Full-Stack Developer}{Sep 2022 - December 2023}
\resumeItemListStart
...
Spearheaded the development efforts for iOS and Android applications (Java and Kotlin), ensuring intuitive user experiences and high-performance functionality.\\
...
\resumeSubheading
{Asrez}{Kashan, Hybrid}
{Chief Technology Officer}{Sep 2021 - January 2023}
\resumeItemListStart
...
\vspace{-1mm}
\resumeSubheading
{Open Sauced}{Part-Time, Remote}
{Open Source Contributor}{May 2022 - May 2023}
\resumeItemListStart
...
\vspace{-1mm}
\resumeSubheading
{KhodroMarket}{Part-Time, Remote}
{.Net Core Developer}{Nov 2022 - August 2023}
\resumeItemListStart
...
% {Founder and Creator}{January 2016 - Present}

\vspace{-1mm}
\resumeSubheading
{Mirese}{Iran}
{Senior Back-End Engineer}{January 2022 - May 2022}
\resumeItemListStart
...
{Senior Software Engineer}{January 2021 - February 2021}
\resumeItemListStart
...
{Research Assistant}{December 2019 - December 2023}
\resumeItemListStart
...
{Software Engineer}{Oct 2019 - December 2019}
\resumeItemListStart
...
{Software Engineer}{March 2017 - July 2017}
\resumeItemListStart
...
HTML, CSS, Python, PHP, C, C\#, Windows Forms, WPF, JavaScript, XML, Android (Java, and Kotlin), FreeBSD, GNU/Linux, SQL/NoSQL Databases, etc.
\resumeItemListEnd
...
\textbf{MBA in Project Management}: Euro American Institute\\
\textbf{Bachelor in (Dual Major) Pure and Applied Mathematics and Computer Science}: University of Kashan\\
\textbf{Bachelor in Computer Engineering}: Islamic Azad University\\
\textbf{Master's in Applied Mathematics, Cryptography and Coding Theory}: Islamic Azad University (Pending)\\
\textbf{Bachelor in Statistics and Its Applications}: University of Kashan (Pending)\\
\textbf{Bachelor of Theology}: Dar Al-Elm School (Pending)\\
...
\textbf{Integrating AI (Artificial Intelligence)into Business Processes}\\
Language: Persian, Length: 74 pages\\

\textbf{What Are AI (Artificial Intelligence) Agents?}\\
Language: Persian, Length: 53 pages\\

\section{\textbf{Visited Countries}}

Belgium, Estonia, France, Germany, Greece, Iran, Iraq, Italy, Japan, Latvia, Netherlands, Portugal, Qatar, Spain, Sweden, Türkiye, United Arab Emirates, etc.

\section{\textbf{Visited Universities (gave course/talks)}}
...
Portugal, University of Portugal\\
...
Türkiye, Yıldız Technical University\\
etc.
...
\textbf{July 2023: AI (Artificial Intelligence) in Software Development Conf’23 - Online}\\
...
\textbf{January 2021: Meeting Baz - Online (COVID)}\\
“Take a Deep Look at JIT Compilers”\\
\textbf{January 2020: 12th Iranian International Group Theory Conference - Online (COVID)}\\
“GAP (Group Algorithm Programming)”\\
\textbf{February 2020 12th Iranian Group Theory Conference - Tehran, Iran}\\
“GAP (Group Algorithm Programming)”\\
\textbf{January 2019: International GAP workshop - Tehran, Iran}\\
...
“The Power of AI (Artificial Intelligence) and ML in E-commerce: Crafting Personalized Shopping Experiences and Boosting Sales with Recommendation Systems”\\
